...
def saveFullConfig(odir,i2c,daq,cli,filename):


    #Bug fixed!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 6 May 2024 - start
    yamlWithoutSC = {} #see format in Board_swamp.py :-(
    for k in i2c.yamlConfig.keys():
        if k.startswith("roc_s"):
            yamlWithoutSC[k]=i2c.yamlConfig[k]['sc']

    ret=i2c.read_config(yamlWithoutSC)
    #Bug fixed!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 6 May 2024 - end
    ...
    with open(odir+"/"+filename,'w') as fout:
