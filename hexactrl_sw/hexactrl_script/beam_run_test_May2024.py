...
configs = [
    ...
    #"sipm_roc0_onbackup0_gainconv4_pre_series_TB_testing.yaml"
    #"sipm_roc0_onbackup0_gainconv4_pre_series_TB_testing.yaml"
    "sipm_roc0_onbackup0_gainconv4_pre_series_TB_testing_expanded_triminv_D8_11.yaml"
    #"sipm_roc0_onbackup0_gainconv4_pre_series_TB_testing.yaml"
...
OV_dict = {
     ...
     "TB3_D8_6": { 
        '4V': {'A': 195, 'B': 124}, #43.89V
     },
     
     "TB3_D8_8": { 
        '4V': {'A': 195, 'B': 125}, #43.79V
     },
     "TB3_D8_11": {
...
def beam_run(i2csocket,daqsocket, clisocket, basedir,tileboard, nruns,OV_val,config,timestamp):
    ...
    odir = "%s/%s/test_beam_run/run_ch_%s_%s/OV%s/%s/"%( os.path.realpath(basedir), tileboard, channel, timestamp, OV_val, convGain )
    ...
    for key in i2csocket.yamlConfig.keys():
        if key.find('roc_s')==0:
            ...
            nestedConf[key]['sc']['DigitalHalf'][0]['L1Offset'] = 12 #13 #=============================================change manually
            nestedConf[key]['sc']['DigitalHalf'][1]['L1Offset'] = 12 #13 #=============================================change manually
            nestedConf[key]['sc']['Top'][0]['phase_ck']= 0 #=============================================change manually
...
#    parser.add_option("--ov",type=int,default='4V',
#                      action="store", dest="ov",
#                      help="Provide the OverVoltage, default '4V'")
