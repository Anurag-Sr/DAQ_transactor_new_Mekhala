...
class zmqController:
    ...
    def update_yamlConfig(self,fname="",yamlNode=None):
        ...
        #Test by Jia-Hao
        print("")
        print("update_yamlConfig: self.yamlConfig  before merging from zmq_controler.py")
        print("")
        print(self.yamlConfig)
        print("")
        #End of test by Jia-Hao

        #Test by Jia-Hao
        print("")
        print("update_yamlConfig: config from zmq_controler.py")
        print("")
        print(config)
        print("")
        #End of test by Jia-Hao
        ...
        #Test by Jia-Hao
        print("")
        print("update_yamlConfig: self.yamlConfig  after merging from zmq_controler.py ")
        print("")
        print(self.yamlConfig)
        print("")
        #End of test by Jia-Hao
    ...
    def configure(self,fname="",yamlNode=None):
        ...
        #Test by Jia-Hao
        print("")
        print("def configure from zmq_controler.py")
        print("")
        print(config)
        print("")
        #End of test by Jia-Hao
