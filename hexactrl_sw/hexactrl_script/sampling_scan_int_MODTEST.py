...
import zmq_controler_bkp as zmqctrl
...
def sampling_scan(i2csocket,daqsocket, clisocket, basedir,device_name, injectionConfig,suffix=""):
    ...
    odir = "%s/%s/TB3_D8_9/PreampSampling_scan_TB3_D8_9_2_MODTEST/"%( os.path.realpath(basedir), device_name) # a comlete path is needed
...
if __name__ == "__main__":
    ...
    injectionConfig = {
        ...
        #'injectedChannels' : [6, 10, 45, 52, 8, 12, 14, 16]  # scan 5
         'injectedChannels' : [2, 4, 6, 8, 10, 15, 45, 52]
