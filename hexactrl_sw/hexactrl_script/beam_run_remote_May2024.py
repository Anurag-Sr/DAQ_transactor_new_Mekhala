...
def beam_run(i2csocket,daqsocket, clisocket, basedir,tileboard, nruns,OV_val,config,timestamp, channel):
    ...
    odir = "%s/%s/beam_run/run_ch_%s_%s/OV%s/%s/"%( os.path.realpath(basedir), tileboard, channel, timestamp, OV_val, convGain )
