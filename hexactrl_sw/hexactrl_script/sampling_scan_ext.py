...
#=========================================================================================
    ...
    for BX in range(startBX, stopBX, stepBX):
        ...
        ##daqsocket.yamlConfig['daq']['menus']['calibAndL1A']['NEvents']=2500
        ...
        #daqsocket.yamlConfig['daq']['menus']['calibAndL1A']['prescale']=10
        #daqsocket.yamlConfig['daq']['menus']['calibAndL1A']['calibType']="CALPULEXT"
     
        #daqsocket.yamlConfig['daq']['menus']['calibAndL1A']['bxL1A']=BX
        #daqsocket.yamlConfig['daq']['menus']['calibAndL1A']['lengthL1A']=1
        ##daqsocket.yamlConfig['daq']['menus']['calibAndL1A']['calibType']="L1A"
...
def sampling_scan(i2csocket,daqsocket, clisocket, basedir,device_name, injectionConfig,suffix=""):
    ...
    #odir = "%s/%s/sampling_scan/run_%s/"%( os.path.realpath(basedir), device_name, timestamp ) # a comlete path is needed #-----------------original
    odir = "%s/%s/sampling_scan_ext/TB3_1_LED_scan_OV%iV_%imV_%s/"%( os.path.realpath(basedir), device_name, voltages, LEDvolt, timestamp) 
    os.makedirs(odir)
...
if __name__ == "__main__":
    ...
    injectionConfig = {
        ...
        'calib' : 50, #900 in original
        #'injectedChannels' : [10,10+18,10+36,10+18+36],
        #'injectedChannels' : [10],
        'injectedChannels' : [15, 51, 49, 50, 14, 13],
