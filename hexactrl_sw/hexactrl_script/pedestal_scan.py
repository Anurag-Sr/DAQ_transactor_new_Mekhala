    ...
    for ref_val in range(start,stop,step):
        ...
        for key in i2csocket.yamlConfig.keys():
            if key.find('roc_s')==0:
                ...
                for ch_number in range(0, 72):
                    nestedConf[key]['sc']['ch'][ch_number]['trim_inv']=ref_val
                for cm_number in range(0, 4):
                    nestedConf[key]['sc']['cm'][cm_number]['trim_inv']=ref_val
                nestedConf[key]['sc']['calib'][0]['trim_inv']=ref_val
                nestedConf[key]['sc']['calib'][1]['trim_inv']=ref_val
