...
def read_sca_config(i2csocket,daqsocket, clisocket, basedir,device_name,tileboard,OV):
    ...
    print("Set GPIOs")
    i2csocket.set_gbtsca_gpio_direction(0xCfffff9C) # '0': input, '1': output
    ...
    # i2csocket.set_gbtsca_gpio_vals(0x00100000,0x00300000) # First argument: GPIO value, 2nd argument: Mask
    # Enable BIAS1: Put '1' in first vector. Enable BIAS2: Put '2'. The mask always stays '3' in 2nd vector 
    
    # enable MPPC_BIAS3 ("1"), disable MPPC_BIAS4 ("0"): GPIOs 20, 21
    i2csocket.set_gbtsca_gpio_vals(0x00040000,0x000C0000) # First argument: GPIO value, 2nd argument: Mask
    # i2csocket.set_gbtsca_gpio_vals(0x00040000,0x000C0000) # First argument: GPIO value, 2nd argument: Mask
    # Enable BIAS3: Put '4' in first vector. Enable BIAS4: Put '8' in first vector. Mask 'C' always stays.
    ...
    '''
    i2csocket.set_gbtsca_dac("A",107)
    print("Dac A value is now",i2csocket.read_gbtsca_dac("A"))
    i2csocket.set_gbtsca_dac("B",122)
    print("Dac B value is now",i2csocket.read_gbtsca_dac("B"))

    i2csocket.set_gbtsca_dac("C",108)   # 35V: 150   30V: 124   25V: 99 
    ...
    sleep(5)   # wait 5s for stabilization of voltages before readback
    ...
    print(" Temp-sensors Nr. 3 and 7 not installed!!")
    ...
    fout.write("ERROR2: " + str(hex((SCA_IOS & 0x00000020)>>5)) + '\n')

    print("PLL_LCK ROC2 (no error = 1): ", hex((SCA_IOS & 0x00000040)>>6))
    fout.write("PLL_LCK2: " + str(hex((SCA_IOS & 0x00000040)>>6)) + '\n')
    ...
    fout.write("EN_HV2: " + str(hex((SCA_IOS & 0x00040000)>>18)) + '\n')

    print("EN_HV3 (ALDOV2 BV2 (1: ON): ", hex((SCA_IOS & 0x00080000)>>19))
    fout.write("EN_HV3: " + str(hex((SCA_IOS & 0x00080000)>>19)) + '\n')
