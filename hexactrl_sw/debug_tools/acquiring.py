...
if __name__ == "__main__":
    ...
    dev.getNode("fastcontrol.periodic0.bx").write(0x10)
    dev.getNode("fastcontrol.periodic1.bx").write(0x50)
    dev.getNode("fastcontrol.periodic2.bx").write(0x100)
    dev.getNode("fastcontrol.periodic3.bx").write(0x200)

    dev.getNode("fastcontrol.periodic0.flavor").write(0x0)
    dev.getNode("fastcontrol.periodic1.flavor").write(0x0)
    dev.getNode("fastcontrol.periodic2.flavor").write(0x0)
    dev.getNode("fastcontrol.periodic3.flavor").write(0x0)

    dev.getNode("fastcontrol.periodic0.orbit_prescale").write(0x0)
    dev.getNode("fastcontrol.periodic1.orbit_prescale").write(0x0)
    dev.getNode("fastcontrol.periodic2.orbit_prescale").write(0x10)
    dev.getNode("fastcontrol.periodic3.orbit_prescale").write(0x10)

    dev.getNode("fastcontrol.periodic0.burst_length").write(0x1)
    dev.getNode("fastcontrol.periodic1.burst_length").write(0x2)
    dev.getNode("fastcontrol.periodic2.burst_length").write(0x1)
    dev.getNode("fastcontrol.periodic3.burst_length").write(0x1)

    dev.getNode("fastcontrol.periodic0.enable_follow").write(0x0)
    dev.getNode("fastcontrol.periodic1.enable_follow").write(0x0)
    dev.getNode("fastcontrol.periodic2.enable_follow").write(0x0)
    dev.getNode("fastcontrol.periodic3.enable_follow").write(0x0)

    dev.getNode("fastcontrol.periodic0.follow_which").write(0x0)
    dev.getNode("fastcontrol.periodic1.follow_which").write(0x0)
    dev.getNode("fastcontrol.periodic2.follow_which").write(0x0)
    dev.getNode("fastcontrol.periodic3.follow_which").write(0x0)
    
    dev.getNode("fastcontrol.periodic0.enable").write(0x1)
    dev.getNode("fastcontrol.periodic1.enable").write(0x0)
    dev.getNode("fastcontrol.periodic2.enable").write(0x0)
    dev.getNode("fastcontrol.periodic3.enable").write(0x0)

        # dev.getNode("fastcontrol.command.enable_random_l1a").write(0x1)
    ...
    for link in options.links:
        ...
        dev.dispatch()
        #print( [format(i,'08X') for i in data] )
        bx = [ (data[i*43]>>16)&0xfff for i in range(event_per_burst) ]
        print( bx )
