...
roc0.set_transport(transport_i2c)
roc0.pll_lock()
...
roc1.set_transport(transport_i2c)
roc1.pll_lock()
...
input('press enter')
with open('../swamp_test/roc_test_config0.yml') as file1:
...
input('press enter')
print('Read-back of a register on the ROC0:')
read_val0 =  roc0.read_reg(47, 11)
input('press enter')
print('Read-back of a register on the ROC1:')
