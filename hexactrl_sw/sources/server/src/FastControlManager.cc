...
void FastControlManager::resetFC()
{
  ...
  prel1a_offset(0x1); // don't see why it should be different than that
...
{
  m_uhalHW->getNode("fastcontrol.command.enable_fast_ctrl_stream").write(val);
}
void FastControlManager::force_idles(int val)
{
  m_uhalHW->getNode("fastcontrol.command.force_idles").write(val);
}
void FastControlManager::enable_orbit_sync(int val)
{
  m_uhalHW->getNode("fastcontrol.command.enable_orbit_sync").write(val);
}
void FastControlManager::enable_global_l1a(int val)
{
  m_uhalHW->getNode("fastcontrol.command.global_l1a_enable").write(val);
}
void FastControlManager::prel1a_offset(int val)
{
  m_uhalHW->getNode("fastcontrol.command.prel1a_offset").write(val);
}
void FastControlManager::enable_external_l1a(int val)
{
  m_uhalHW->getNode("fastcontrol.command.enable_external_l1as").write(val);
}
void FastControlManager::enable_random_l1a(int val)
{
  m_uhalHW->getNode("fastcontrol.command.enable_random_l1a").write(val);
}
void FastControlManager::enable_block_sequencer(int val)
{
  m_uhalHW->getNode("fastcontrol.command.enable_block_sequencer").write(val);
}
void FastControlManager::enable_nzs_generator(int val)
{
  m_uhalHW->getNode("fastcontrol.command.enable_nsz_generator").write(val);
}
void FastControlManager::enable_nzs_jitter(int val)
{
  m_uhalHW->getNode("fastcontrol.command.enable_nsz_jitter").write(val);
}

//REQUESTS
void FastControlManager::request_reset_nzs()
{
  m_uhalHW->getNode("fastcontrol.request.reset_nzs").write(0x1);
}
void FastControlManager::request_count_rst()
{
  m_uhalHW->getNode("fastcontrol.request.count_rst").write(0x1);
}
void FastControlManager::request_sequence()
{
  m_uhalHW->getNode("fastcontrol.command.request_sequence_req").write(0x1);
}
void FastControlManager::request_orbit_rst()
{
  m_uhalHW->getNode("fastcontrol.request.orbit_count_reset").write(0x1);
}
void FastControlManager::request_chipsynq()
{
  m_uhalHW->getNode("fastcontrol.request.chipsynq").write(0x1);
}
void FastControlManager::request_ebr()
{
  m_uhalHW->getNode("fastcontrol.request.ebr").write(0x1);
}
void FastControlManager::request_ecr()
{
  m_uhalHW->getNode("fastcontrol.request.ecr").write(0x1);
}
void FastControlManager::request_link_reset_roct()
{
  m_uhalHW->getNode("fastcontrol.request.link_reset_roct").write(0x1);
}
void FastControlManager::request_link_reset_rocd()
{
  m_uhalHW->getNode("fastcontrol.request.link_reset_rocd").write(0x1);
}
void FastControlManager::request_link_reset_econt()
{
  m_uhalHW->getNode("fastcontrol.request.link_reset_econt").write(0x1);
}
void FastControlManager::request_link_reset_econd()
{
  m_uhalHW->getNode("fastcontrol.request.link_reset_econd").write(0x1);
}

//BX for requests
void FastControlManager::bx_orbit_synq(int val)
{
  m_uhalHW->getNode("fastcontrol.bx_orbit_synq").write(val);
}
void FastControlManager::bx_chipsynq(int val)
{
  m_uhalHW->getNode("fastcontrol.bx_chipsynq").write(val);
}
void FastControlManager::bx_ebr(int val)
{
  m_uhalHW->getNode("fastcontrol.bx_ebr").write(val);
}
void FastControlManager::bx_ecr(int val)
{
  m_uhalHW->getNode("fastcontrol.bx_ecr").write(val);
}
void FastControlManager::bx_link_reset_roct(int val)
{
  m_uhalHW->getNode("fastcontrol.bx_link_reset_roct").write(val);
}
void FastControlManager::bx_link_reset_rocd(int val)
{
  m_uhalHW->getNode("fastcontrol.bx_link_reset_rocd").write(val);
}
void FastControlManager::bx_link_reset_econt(int val)
{
  m_uhalHW->getNode("fastcontrol.bx_link_reset_econt").write(val);
}
void FastControlManager::bx_link_reset_econd(int val)
{
  m_uhalHW->getNode("fastcontrol.bx_link_reset_econd").write(val);
}

// Random gen and external L1A settings
void FastControlManager::minimum_trigger_period(int val)
{
  m_uhalHW->getNode("fastcontrol.minimum_trigger_period").write(val);
}
void FastControlManager::random_trigger_log2_period(int val)
{
  m_uhalHW->getNode("fastcontrol.random_trigger_log2_period").write(val);
}
void FastControlManager::external_triggers_debounce(int val)
{
  m_uhalHW->getNode("fastcontrol.external_triggers_debounce").write(val);
}
void FastControlManager::external_trigger_delay(int chan, int val)
{
  char buf[200];
  sprintf(buf,"%s%d","fastcontrol.external_trigger_delay.bit",chan);
...
{
  m_uhalHW->getNode("fastcontrol.command_sequence.length").write(val);
}

void FastControlManager::command_sequence_bx(int val)
{
  m_uhalHW->getNode("fastcontrol.command_sequence.bx").write(val);
}

void FastControlManager::command_sequence_orbit_prescale(int val)

{
  m_uhalHW->getNode("fastcontrol.command_sequence.orbit_prescale").write(val);
}

void FastControlManager::command_sequence_page(int val)
{
  m_uhalHW->getNode("fastcontrol.command_sequence.page").write(val);
}

void FastControlManager::command_sequence_contents(const std::vector<uint32_t>& vec)
{
  m_uhalHW->getNode("fastcontrol.command_sequence.contents").writeBlock(vec);
}
...
void FastControlManager::set_fc_periodic_settings(int periodic_chan, int enable, int bx, int prescale, FC_channel_flavor flavor, int length, FC_channel_follow follow)
{
  ...
  sprintf(enablebuf      ,"%s%d%s","fastcontrol.periodic",periodic_chan,".enable");
  sprintf(flavorbuf      ,"%s%d%s","fastcontrol.periodic",periodic_chan,".flavor");
  sprintf(enablefollowbuf,"%s%d%s","fastcontrol.periodic",periodic_chan,".enable_follow");
  sprintf(followwhichbuf ,"%s%d%s","fastcontrol.periodic",periodic_chan,".follow_which");
  sprintf(bxbuf          ,"%s%d%s","fastcontrol.periodic",periodic_chan,".bx");
  sprintf(prescalebuf    ,"%s%d%s","fastcontrol.periodic",periodic_chan,".orbit_prescale");
  sprintf(lengthbuf      ,"%s%d%s","fastcontrol.periodic",periodic_chan,".burst_length");
...
// void FastControlManager::set_l1a_n_consecutive(int val)
// {
//   m_uhalHW->getNode("fastcontrol.l1a_settings.n_consecutive_l1a").write(val);
// }
...
{
  char buf[200];
  sprintf(buf,"%s.%s","fastcontrol",reg.c_str());
  m_uhalHW->getNode(buf).write(val);
}
