...
class Translator():
    ...
    def __init__(self, roc_type):
        ...
        elif roc_type=="Siv3": self.paramMap = self.__load_param_map("./reg_maps/HGCROC3_I2C_params_regmap_dict.pickle")
        elif roc_type=="SiPMv3": self.paramMap = self.__load_param_map("./reg_maps/HGCROC3_sipm_I2C_params_regmap_dict.pickle") # added by Jia-Hao Li on 09022023 20:13
