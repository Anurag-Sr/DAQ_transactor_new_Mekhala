...
class CharBoard():
    ...
    def configure(self, cfgs):
        ...
        print("Starting configure")   ### New print here
        threads = []
        for lbl, cfg in cfgs.items():
            print("Found label "+lbl+" in yaml config")            ### New print here 
            for rname in [name for name in self.rocs.keys() if lbl in name]:
                print("Creating thread to configure roc " + rname)      ### New print here
                roc = self.rocs[rname]
    ...
    def __detect_roc_type(self):
        ...
        print("answer:")
        print(answer)
        print("ROC value from register 32, 37:")
        print(val)
        #===================
        ...
        #================================add by Jia-Hao 14022023
        elif val == 0:
            print('[roc_s*] Detected SiPMv3 type')
            return "SiPMv3"
        #===============================================        
